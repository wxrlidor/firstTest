	...
	<li class="param">
		<ul>
			<li>
				...
				&nbsp;<a href="javascript:void(0)" class="easyui-linkbutton delGroup"  title="删除组" data-options="plain:true,iconCls:'icon-cancel'"></a>
			</li>
			<li>
...
<script style="text/javascript">
	$(function(){
		...
		$("#itemParamAddTable .submit").click(function(){
			...
			//JSON.stringify(params)把json格式的数据转换层String格式
